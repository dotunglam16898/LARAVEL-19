                    ...
                    <div class="card-body">
                        ...
                        <div class="list-wrapper">
                            <ul class="d-flex flex-column-reverse todo-list">
                                ...
                                <li>Lập trình Laravel
                                    <div class="form-check" style="margin-left: 312px;">
                                        <a href="{{ route('todo.task.complete') }}" class="btn btn-success" type="submit">Hoàn thành</a>
                                      <a href="{{ route('todo.task.reset') }}" class="btn btn-danger">Xóa</a>

                                  </div> 
                              </li>
                              <li class="completed">Làm bài tập PHP
